package fr.pierre.varlib.launching;

import fr.pierre.varlib.launching.types.Type;
import fr.pierre.varlib.launching.types.VersionType;
import fr.pierre.varlib.util.Util;
...
public class GameLauncher {
    ...
    public void launch() throws IOException {
        ...
        vmArgs.addAll(this.versionType.getArgs(this));
